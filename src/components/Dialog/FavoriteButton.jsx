...
const FavoriteButton = () => {
  return (
      <Dialog.Root>
        <Dialog.Trigger
          type="button"
          className="bg-zinc-800 hover:bg-zinc-900/80 rounded-sm p-3  md:p-4"
      >
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed p-5 right-0 top-0 h-full w-[400px] md:w-[600px] z-50 bg-white shadow-lg  transition-transform ease-out ">
